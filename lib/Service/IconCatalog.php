...
/**
 * Inline Lucide-style SVG icons for SnackCheck templates (prefix snk-).
 */
final class IconCatalog
{
	private const ICONS = [
		'fridge' => '<rect x="7" y="2" width="10" height="20" rx="2"/><path d="M7 10h10"/><path d="M10 6v2"/><path d="M10 14v2"/>',
		...
		'calendar-range' => '<rect x="3" y="4" width="18" height="18" rx="2"/><path d="M16 2v4M8 2v4M3 10h18"/><path d="M17 14h-6"/><path d="M13 18H7"/><path d="M7 14h.01"/><path d="M17 18h.01"/>',
	...
	/** Default tile glyph when no custom picture is set. */
	...
	public static function render(string $name, ?string $extraClass = null): string
	{
		...
		$class = 'snk-icon' . ($extraClass !== null ? ' ' . htmlspecialchars($extraClass, ENT_QUOTES, 'UTF-8') : '');
		return sprintf(
